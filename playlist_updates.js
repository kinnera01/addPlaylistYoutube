...
function getyoutubeids(){
  console.log("HEY I AM IN YIDS")
    ...
    var queryurl="http://aurora.cs.rutgers.edu:8181/solr/#/discogs_data_test/query/select?q=releaseDate:"+year+'&sort=viewcountRate%20desc&start=0&rows=50&wt=json&indent=true';
